	...
	<div class="main">
		...
		<div class="content">
			...
			<form id="mainForm" method="post" action="checkLogin">
				<fieldset>
					<div class="input">
						<input class="input_all name" name="name" id="name"
					...
					<div class="input">
						<input
							class="input_all password" id="password" name="password" type="password"
							placeholder="密码"
					...
					<div class="enter">
						<input class="button hide" type="submit" id="submit_login"
							value="登录" />
					</div>
				</fieldset>
			</form>
