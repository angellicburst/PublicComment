...
<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<body style="background: #e1e9eb;">
		...
		<form id="mainForm" method="post" action="updateAd" enctype="multipart/form-data">
				...
				<div class="rightCont">
					...
					<table class="tab1" width="100%">
						<tbody>
							...
							<td width="30%">
								<input id="title" name="title" value="${advance.title }" class="allInput" style="width:100%;" type="text"/>
							</td>
							<td align="right" width="10%">上传图片：</td>
							<td width="30%">
								<a href="${advance.imgUrl }">查看图片</a>
						...
						<tr>
							...
							<td width="30%">
								<input id="link" name="link"  value="${advance.link }" class="allInput" style="width:100%;" type="text"/>
							</td>
							<td align="right" width="10%">权重(值越大排名越靠前)<font color="red">*</font>：</td>
							<td width="30%">
								<input id="weight" name="weight"  value="${advance.weight }" class="allInput" style="width:100%;" type="text"/>
							</td>
						</tr>
					  </tbody>
					</table>
					<div style="text-align: center; margin-top: 30px;">
						...
						<input class="tabSub" value="返     回" type="button" onclick="location.href='${basepath }/adList?pageIndex=${pageIndex }'"/>
					</div>
				</div>
			</div>
		</form>
